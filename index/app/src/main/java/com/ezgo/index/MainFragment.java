...
public class MainFragment extends Fragment implements
    ...
    private String targetPosition[]=new String[2]; //導航目標的位置(傳給unity)
    ...
    private void setMarkers(int type){
        for(int i=0; i<mMarkers.length; i++){
            ...
            if(type==1){
                markerOptions.position(position).icon(BitmapDescriptorFactory.fromResource(wsIcon[i])); //闖關單為旗子Marker
